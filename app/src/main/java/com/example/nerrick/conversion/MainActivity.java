package com.example.nerrick.conversion;
...
public class MainActivity extends ActionBarActivity {
    ...
    public void addItemsToUnitTypeSpinner(){
        ...
        ArrayAdapter<CharSequence> unityTypeSpinnerAdapter = ArrayAdapter.createFromResource(this,R.array.conversion_types,
                android.R.layout.simple_spinner_item);

        unityTypeSpinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

        unitTypeSpinner.setAdapter(unityTypeSpinnerAdapter);
